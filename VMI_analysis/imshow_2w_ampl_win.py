# # Plot_colorscale Ph VS angle VS energy
...
class imshow_2w_ampl_Win(QDialog):
    ...
    def init_graphlayout(self) -> None:
        ...
        # heatmap = matplotlib.pyplot.pcolor(self.Z2, cmap='jet')
        cbar = matplotlib.pyplot.colorbar()
        cbar.set_label('Amplitude [arb.u.]')
        matplotlib.pyplot.xlabel('Energy [eV]')
        matplotlib.pyplot.ylabel('Emission angle [°]')
        matplotlib.pyplot.title('2w amplitude as a function of energy and emission angle')
